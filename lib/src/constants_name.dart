var firstNamesFemale = Set<String>.from([
...
var firstNamesMale = Set<String>.from([
...
var prefixesFemale = ['Mrs.', 'Ms.', 'Miss', 'Dr.'];
var prefixesMale = ['Mr.', 'Dr.'];
