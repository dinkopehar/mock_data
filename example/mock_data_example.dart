...
void main() {
  ...
  mockUrl('*', true, false,
      true); // Fragment part https://example.net/bar/baz?b=3&username=waldo#above
  // ---------
  ...
  mockLocation(53.5587, 108.1650,
      1000); // Generate random location in radius 1000 metres from the point.
  // ---------
